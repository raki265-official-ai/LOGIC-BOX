...
1.pattern generator-generate a right angle triangle

2.number analyzer-analyse numbers in a given range by checing odd/even and calucalte the total sum

this project is practice designs python concepts 
